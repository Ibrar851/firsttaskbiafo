...
export default function MagazinesPage() {
  ...
  <Row className="g-3">
    {[
      { img: Ab1, title: "Google announces free one-year AI Pro Plan for Pakistani students", desc: "Offer allows eligible Pakistani students to access Google's most capable AI features."},
      { img: Ab2, title: "Is Pak Truck Driver the most exciting driving to from Pakistan?", desc: "Now you can experience trucking through the Karakorum Highway without moving."},
      { img: Ab3, title: "PTA urges YouTube to unblock Dr Israr’s channel", desc: "The unilateral shutdown raises questions about the arbitrary limits of online"},
      { img: Ab4, title: "Explainer: Why did a Cloudflare outage cause websites to go down?", desc: "Websites relying on DNS services can go inaccessible instantly."},
      { img: Ab5, title: "Cloudflare says fix implemented after global outage", desc: "X, Spotify, ChatGPT among websites affected; issue resolved for many users."},
      { img: Ab6, title: "Game review: Ghost of Yotei is 40 hours of art", desc: "A tough but beautiful combat-focused experience set against a scenic backdrop."},
      { img: Ab7, title: "Govt establishes Pakistan Digital Authority", desc: "Authority members to operate directly under the IT ministry."},
      { img: Ab8, title: "InDrive expands to five new cities across Pakistan", desc: "Company aims to provide seamless and reliable mobility services."},
    ].map((item, i) => (
      <Col md={3} key={i}>
        <Card className="border-0 shadow-sm">
          <Card.Img
  ...
  <Row className="g-3">
    {[
      { img: Eos1, title: "Google announces free one-year AI Pro Plan for Pakistani students", desc: "Offer allows eligible Pakistani students to access Google's most capable AI features."},
      { img: Eos2, title: "Is Pak Truck Driver the most exciting driving to from Pakistan?", desc: "Now you can experience trucking through the Karakorum Highway without moving."},
      { img: Eos3, title: "PTA urges YouTube to unblock Dr Israr’s channel", desc: "The unilateral shutdown raises questions about the arbitrary limits of online"},
      { img: Eos4, title: "Explainer: Why did a Cloudflare outage cause websites to go down?", desc: "Websites relying on DNS services can go inaccessible instantly."},
      { img: Eos5, title: "Cloudflare says fix implemented after global outage", desc: "X, Spotify, ChatGPT among websites affected; issue resolved for many users."},
      { img: Eos6, title: "Game review: Ghost of Yotei is 40 hours of art", desc: "A tough but beautiful combat-focused experience set against a scenic backdrop."},
      { img: Eos7, title: "Govt establishes Pakistan Digital Authority", desc: "Authority members to operate directly under the IT ministry."},
      { img: Eos8, title: "InDrive expands to five new cities across Pakistan", desc: "Company aims to provide seamless and reliable mobility services."},
    ].map((item, i) => (
      <Col md={3} key={i}>
        <Card className="border-0 shadow-sm">
          <Card.Img
...
<Card className="mb-4 border-0 shadow-sm p-3">
  ...
  <Row className="g-3">
    {[
      { img: Icon1, title: "Google announces free one-year AI Pro Plan for Pakistani students", desc: "Offer allows eligible Pakistani students to access Google's most capable AI features."},
      { img: Icon2, title: "Is Pak Truck Driver the most exciting driving to from Pakistan?", desc: "Now you can experience trucking through the Karakorum Highway without moving."},
      { img: Icon3, title: "PTA urges YouTube to unblock Dr Israr’s channel", desc: "The unilateral shutdown raises questions about the arbitrary limits of online"},
      { img: Icon4, title: "Explainer: Why did a Cloudflare outage cause websites to go down?", desc: "Websites relying on DNS services can go inaccessible instantly."},
      { img: Icon5, title: "Cloudflare says fix implemented after global outage", desc: "X, Spotify, ChatGPT among websites affected; issue resolved for many users."},
      { img: Icon6, title: "Game review: Ghost of Yotei is 40 hours of art", desc: "A tough but beautiful combat-focused experience set against a scenic backdrop."},
      { img: Icon7, title: "Govt establishes Pakistan Digital Authority", desc: "Authority members to operate directly under the IT ministry."},
      { img: Icon8, title: "InDrive expands to five new cities across Pakistan", desc: "Company aims to provide seamless and reliable mobility services."},
    ].map((item, i) => (
      <Col md={3} key={i}>
        <Card className="border-0 shadow-sm">
          <Card.Img
...
<Card className="mb-4 border-0 shadow-sm p-3">
  ...
  <Row className="g-3">
    {[
      { img: Fin1, title: "Google announces free one-year AI Pro Plan for Pakistani students", desc: "Offer allows eligible Pakistani students to access Google's most capable AI features."},
      { img: Fin2, title: "Is Pak Truck Driver the most exciting driving to from Pakistan?", desc: "Now you can experience trucking through the Karakorum Highway without moving."},
      { img: Fin3, title: "PTA urges YouTube to unblock Dr Israr’s channel", desc: "The unilateral shutdown raises questions about the arbitrary limits of online"},
      { img: Fin4, title: "Explainer: Why did a Cloudflare outage cause websites to go down?", desc: "Websites relying on DNS services can go inaccessible instantly."},
      { img: Fin5, title: "Cloudflare says fix implemented after global outage", desc: "X, Spotify, ChatGPT among websites affected; issue resolved for many users."},
      { img: Fin6, title: "Game review: Ghost of Yotei is 40 hours of art", desc: "A tough but beautiful combat-focused experience set against a scenic backdrop."},
      { img: Fin7, title: "Govt establishes Pakistan Digital Authority", desc: "Authority members to operate directly under the IT ministry."},
      { img: Fin8, title: "InDrive expands to five new cities across Pakistan", desc: "Company aims to provide seamless and reliable mobility services."},
    ].map((item, i) => (
      <Col md={3} key={i}>
        <Card className="border-0 shadow-sm">
          <Card.Img
